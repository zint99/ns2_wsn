...
# 判断命令行参数是否符合要求
if {$argc != 2 || ![string match "cbr*" $argv0]|| ![string match "sc*" $argv1]} {
    puts "Usage: ns aomdv.tcl cbr文件格式 sc文件格式"
    exit 1
}
...
# 创建trace文件
set tracefd [open ../trace/lab2/$val(tr) w]
# use new trace file
$ns_ use-newtrace
$ns_ trace-all $tracefd
set namtracefd [open ../nam/lab2/$val(nam) w]
